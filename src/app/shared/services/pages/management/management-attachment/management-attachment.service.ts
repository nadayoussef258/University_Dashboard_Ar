...
export class ManagementAttachmentService extends HttpService {
  protected get baseUrl(): string {
    return 'v2/managementattachment/';
  }

  getManagementAttachment(id: string) {
    return this.get<any>({ apiName: `Get/${id}` });
  }

  getEditManagementAttachment(id: string) {
    return this.get<any>({ apiName: `getedit/${id}` });
  }

  get managementAttachments() {
