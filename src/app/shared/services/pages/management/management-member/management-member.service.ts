...
export class ManagementMembersService extends HttpService {
  protected get baseUrl(): string {
    return 'v2/managementmember/';
  }

  getManagementMember(id: string) {
    return this.get<any>({ apiName: `Get/${id}` });
  }

  getEditManagementMember(id: string) {
    return this.get<any>({ apiName: `getedit/${id}` });
  }

  get managementMembers() {
