...
export class CenterAttachmentsService extends HttpService {
  protected get baseUrl(): string {
    return 'v2/centerattachment/';
  }

  getCenterAttachment(id: string) {
    return this.get<any>({ apiName: `Get/${id}` });
  }

  getEditCenterAttachment(id: string) {
    return this.get<any>({ apiName: `getedit/${id}` });
  }

  get centerAttachments() {
