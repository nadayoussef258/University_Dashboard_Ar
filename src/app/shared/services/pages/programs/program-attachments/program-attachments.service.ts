...
export class ProgramAttachmentsService extends HttpService {
  protected get baseUrl(): string {
    return 'v2/programattachment/';
  }

  getProgramAttachment(id: string) {
    return this.get<any>({ apiName: `Get/${id}` });
  }

  getEditProgramAttachment(id: string) {
    return this.get<any>({ apiName: `getedit/${id}` });
  }

  get programAttachments() {
