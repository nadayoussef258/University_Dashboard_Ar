...
@Component({
  ...
  template: `
    ...
    <div
      class="bg-surface-50  flex items-center justify-center min-h-screen min-w-[50vw] overflow-hidden"
    >
      <div class="flex flex-col items-center justify-center">
        <div style="background-color:#259BAA;border-radius: 20px">
          <div
            class="w-full bg-surface-0 dark:bg-surface-900 "
            style=" background-color:#D9D9D9 ;border-radius: 20px"
          >
            <div class="text-center mb-8">
              <div
                class="text-surface-900   text-3xl font-medium mb-4 py-3 "
