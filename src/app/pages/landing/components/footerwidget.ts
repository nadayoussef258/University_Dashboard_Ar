      ...
      <div class="grid gap-4 grid-cols-12">
        <div class="col-span-12 md:col-span-2">
          <a
            ...
            class="cursor-pointer flex flex-wrap mb-6 items-center justify-center md:mb-0 md:justify-start"
          >
            <svg
              viewBox="0 0 54 40"
              fill="none"
        ...
        <div class="col-span-12 md:col-span-10">
          <div class="text-center grid gap-8 grid-cols-12 md:text-right">
            <div class="col-span-12 md:col-span-3">
              <h4
                class="font-medium leading-normal mb-6 text-2xl text-surface-900 dark:text-surface-0"
              >
                Company
              </h4>
              <a
                class="cursor-pointer text-xl leading-normal mb-2 text-surface-700 block dark:text-surface-100"
                >About Us</a
              >
              <a
                class="cursor-pointer text-xl leading-normal mb-2 text-surface-700 block dark:text-surface-100"
              ...
              >
              <a
                class="cursor-pointer text-xl leading-normal text-surface-700 block dark:text-surface-100"
                >Media Kit</a
              >
            </div>
