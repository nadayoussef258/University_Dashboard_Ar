...
export const sectorMembersRoutes: Routes = [
  {
    path: '',
    loadComponent: () => import('./sector-members.component').then((c) => c.SectorMembersComponent),
    data: {
  ...
  {
    path: 'add',
    loadComponent: () => import('../add-edit-sector-member/add-edit-sector-member.component').then((c) => c.AddEditSectorMemberComponent),
