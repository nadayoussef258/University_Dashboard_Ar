...
export const sectorServicesRoutes: Routes = [
  {
    path: '',
    loadComponent: () => import('./sector-services.component').then((c) => c.SectorServicesComponent),
    data: {
  ...
  {
    path: 'add',
    loadComponent: () => import('../add-edit-sector-service/add-edit-sector-service.component').then((c) => c.AddEditSectorServiceComponent),
    data: {
