...
export const centerMembersRoutes: Routes = [
  {
    path: '',
    loadComponent: () => import('./center-members.component').then((c) => c.CenterMembersComponent),
    data: {
  ...
  {
    path: 'add',
    loadComponent: () => import('../add-edit-center-member/add-edit-center-member.component').then((c) => c.AddEditCenterMemberComponent),
