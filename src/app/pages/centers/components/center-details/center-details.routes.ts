...
export const centerDetailsRoutes: Routes = [
  {
    path: '',
    loadComponent: () => import('./center-details.component').then((c) => c.CenterDetailsComponent),
    data: {
  ...
  {
    path: 'add',
    loadComponent: () => import('../add-edit-center-detail/add-edit-center-detail.component').then((c) => c.AddEditCenterDetailComponent),
