...
export const actionsRoutes: Routes = [
  {
    path: '',
    loadComponent: () => import('./pages/actions/actions.component').then((c) => c.ActionsComponent),
    data: { pageTitle: 'PAGES.ACTIONS.MAIN.PAGE_TITLE', pageType: 'list' }
  },
  {
    path: 'add',
    loadComponent: () => import('./components/add-edit-action/add-edit-action.component').then((c) => c.AddEditActionComponent),
