...
export const heroSectionsRoutes: Routes = [
  {
    path: '',
    loadComponent: () =>
      import('./page/hero-sections/hero-sections.component').then(
        (c) => c.HeroSectionsComponent
      ),
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './components/add-edit-hero-section/add-edit-hero-section.component'
      ).then((c) => c.AddEditHeroSectionComponent),
