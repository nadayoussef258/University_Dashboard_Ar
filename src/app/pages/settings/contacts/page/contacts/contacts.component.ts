...
export class ContactsComponent extends BaseListComponent {
  ...
  openAdd() {
    this.openDialog(AddEditContactComponent, this.localize.translate.instant('SETTINGS.CONTACTS.ADD.PAGE_TITLE'), {
      pageType: 'add'
    });
  }

  openEdit(rowData: any) {
    this.openDialog(AddEditContactComponent, this.localize.translate.instant('SETTINGS.CONTACTS.EDIT.PAGE_TITLE'), {
      pageType: 'edit',
      row: { rowData }
    });
  }
