...
export const settingsRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'hero-sections',
        loadChildren: () => import('./hero-sections/hero-sections.routes').then((m) => m.heroSectionsRoutes)
      },
      {
        path: 'logos',
        loadChildren: () => import('./logos/logos.routes').then((m) => m.logosRoutes)
      },
      {
        path: 'services',
      ...
      {
        path: 'menu-types',
        loadChildren: () => import('./menu-types/menu-types.routes').then((m) => m.menuTypesRoutes)
      },
      {
        path: 'menu-items',
        loadChildren: () => import('./menu-items/menu-items.routes').then((m) => m.menuItemsRoutes)
      }
    ]
  },
